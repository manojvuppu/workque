...
@Component({
  selector: 'app-create-user-profiles',
  templateUrl: './create-user-profiles.component.html',
  styleUrls: ['./create-user-profiles.component.css']
})
export class CreateUserProfilesComponent implements OnInit {
  ...
  constructor(private _Mainservice: MainService, private ApiService: ApiService, private AppModel: AppModelService, private elemRef: ElementRef,
    public dialogRef: MatDialogRef<CreateUserProfilesComponent>, @Inject(MAT_DIALOG_DATA) public data: any) { }
